...
const PlantsView = () => {
  ...
  //Carga de datos
  useEffect(() => {
    getPagin('http://192.168.20.244:5000/api/Plants',page, setTotalPages, setData, setLoading, recordsPerPage);
    }, [page]
  );
    ...
    <View>
      ...
      <View style={styles.card}>
            <View style={styles.headerRow}>
              <Text style={styles.headerCell}>Nombre de la planta</Text>
            </View>
            <FlatList
              data={filteredData}
